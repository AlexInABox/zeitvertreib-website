...
public static class Utils
{
    ...
    public static async void SendHeaderToPlayer(PlayerJoinedEventArgs ev)
    {
        try
        {
            ...
            lock (SettingsLock)
            {
                ServerSpecificSettingBase[]
                    existing = ServerSpecificSettingsSync.DefinedSettings ??
                               []; //This is SHARED! Always lock manipulation of this object.
        ...
        {
            Logger.Error($"Sending the Header to {ev.Player.Nickname} failed with: " + e);
        }
    }
