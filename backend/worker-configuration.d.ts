/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 166db370508b675eb872b1c7034e4a29)
// Runtime types generated with workerd@1.20260515.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	SESSIONS: KVNamespace;
	ZEITVERTREIB_SESSIONS: KVNamespace;
	ZEITVERTREIB_FLAGS: KVNamespace;
	SCRATCH: KVNamespace;
	ZEITVERTREIB_DATA: D1Database;
	REPORT_UPLOADS_LIMITER: RateLimit;
	FRONTEND_URL: "https://zeitvertreib.vip" | "https://dev.zeitvertreib.vip" | "http://localhost:4200";
	BACKEND_URL: "https://zeitvertreib.vip/api" | "https://dev.zeitvertreib.vip/api" | "http://localhost:8787/api";
	ENVIRONMENT: "production" | "development" | "local";
	STEAM_API_KEY: string;
	OPENAI_API_KEY: string;
	LEADERBOARD_CHANNEL_ID: string;
	GAMBLING_WINS_WEBHOOK: string;
	...
	"KO-FI_VERIFICATION_TOKEN": string;
	"KO-FI_DISCORD_WEBHOOK": string;
	OVERWATCH_API_KEY: string;
	SPRAYED_API_KEY: string;
	FAKERANK_API_KEY: string;
	SWAPPED_API_KEY: string;
	TRACKED_API_KEY: string;
	MINECRAFT_API_KEY: string;
	LOGIN_SECRET_API_KEY: string;
	INFORMED_API_KEY: string;
	PAYSAFE_RECEIVER_USER_ID: string;
	STRIPE_SECRET_KEY: string;
	STRIPE_WEBHOOK_SECRET: string;
	DONATIONS_CHANNEL_ID: string;
	EMAIL_PASSWORD: string;
	PROXIED_API_KEY: string;
	PUSHGATEWAY_USERNAME: string;
	PUSHGATEWAY_PASSWORD: string;
	PTERODACTYL_API_KEY: string;
	PLAYERLIST_STORAGE: DurableObjectNamespace<import("./dist/src/index").PlayerlistStorage>;
	REINSTALL_MANAGER: DurableObjectNamespace<import("./dist/src/index").ReinstallManager>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/src/index");
		durableNamespaces: "PlayerlistStorage" | "ReinstallManager";
	}
	interface ProductionEnv {
		...
		ZEITVERTREIB_DATA: D1Database;
		REPORT_UPLOADS_LIMITER: RateLimit;
		FRONTEND_URL: "https://zeitvertreib.vip";
		BACKEND_URL: "https://zeitvertreib.vip/api";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FRONTEND_URL" | "BACKEND_URL" | "ENVIRONMENT" | "STEAM_API_KEY" | "OPENAI_API_KEY" | "LEADERBOARD_CHANNEL_ID" | "GAMBLING_WINS_WEBHOOK" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_TOKEN" | "GUILD_ID" | "CEDMOD_API_KEY" | "CEDMOD_API_KEY_BANS" | "CEDMOD_API_KEY_WARNS" | "CEDMOD_API_KEY_REPORTS" | "PLAYERLIST_API_KEY" | "MINIO_ACCESS_KEY" | "MINIO_SECRET_KEY" | "KO-FI_VERIFICATION_TOKEN" | "KO-FI_DISCORD_WEBHOOK" | "OVERWATCH_API_KEY" | "SPRAYED_API_KEY" | "FAKERANK_API_KEY" | "SWAPPED_API_KEY" | "TRACKED_API_KEY" | "MINECRAFT_API_KEY" | "LOGIN_SECRET_API_KEY" | "INFORMED_API_KEY" | "PAYSAFE_RECEIVER_USER_ID" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "DONATIONS_CHANNEL_ID" | "EMAIL_PASSWORD" | "PROXIED_API_KEY" | "PUSHGATEWAY_USERNAME" | "PUSHGATEWAY_PASSWORD" | "PTERODACTYL_API_KEY">> {}
}
