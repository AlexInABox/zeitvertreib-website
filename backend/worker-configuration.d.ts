...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'BACKEND_URL'
      | 'ENVIRONMENT'
      | 'LOGIN_SECRET_API_KEY'
      | 'STEAM_API_KEY'
      | 'OPENAI_API_KEY'
      | 'LEADERBOARD_CHANNEL_ID'
      | 'PROXY_HOST'
      | 'GAMBLING_WINS_WEBHOOK'
      ...
      | 'CEDMOD_API_KEY'
      | 'CEDMOD_API_KEY_BANS'
      | 'CEDMOD_API_KEY_WARNS'
      | 'CEDMOD_API_KEY_REPORTS'
      | 'PLAYERLIST_API_KEY'
      | 'MINIO_ACCESS_KEY'
      | 'MINIO_SECRET_KEY'
      | 'KO-FI_VERIFICATION_TOKEN'
      | 'KO-FI_DISCORD_WEBHOOK'
      | 'OVERWATCH_API_KEY'
      | 'SPRAYED_API_KEY'
      | 'FAKERANK_API_KEY'
      | 'SWAPPED_API_KEY'
      | 'TRACKED_API_KEY'
      | 'PAYSAFE_RECEIVER_USER_ID'
