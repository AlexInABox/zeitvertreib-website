...
async function getLeaderboardData(env: Env): Promise<{
  ...
  `,
    ...
    return {
        ...
        pocketescapes: await formatLeaderboard(pocketescapesQuery.results, 'pocketescapes'),
        adrenaline: await formatLeaderboard(adrenalineQuery.results, 'usedadrenaline'),
    };
}
