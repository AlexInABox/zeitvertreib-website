...
export const kills = sqliteTable(
  'kills',
  {
    attacker: text(),
    target: text(),
...
export const discordInfo = sqliteTable(
  'discord_info',
  {
...
export const loginSecrets = sqliteTable(
  'login_secrets',
  {
...
export const adventCalendar = sqliteTable(
  'advent_calendar',
  {
...
export const sprayBans = sqliteTable(
  'spray_bans',
  {
...
export const deletedSprays = sqliteTable(
  'deleted_sprays',
  {
...
export const sprays = sqliteTable(
  'sprays',
  {
...
export const steamCache = sqliteTable(
  'steam_cache',
  {
...
export const paysafeCardSubmissions = sqliteTable(
  'paysafe_card_submissions',
  {
...
export const fakeranks = sqliteTable(
  'fakeranks',
  {
    id: integer().primaryKey({ autoIncrement: true }),
    userid: text().notNull(),
...
export const fakerankBans = sqliteTable(
  'fakerank_bans',
  {
    userid: text().primaryKey(),
    bannedAt: integer('banned_at').default(0).notNull(),
...
export const deletedFakeranks = sqliteTable(
  'deleted_fakeranks',
  {
...
export const lastTakeoutRequests = sqliteTable(
  'last_takeout_requests',
  {
    userid: text().primaryKey(),
...
export const deletionEnabledUsers = sqliteTable(
  'deletion_enabled_users',
  {
    userid: text().primaryKey(),
...
export const birthdayUpdates = sqliteTable(
  'birthday_updates',
  {
    userid: text().primaryKey(),
...
export const chickenCrossGames = sqliteTable(
  'chicken_cross_games',
  {
...
export const reducedLuckUsers = sqliteTable(
  'reduced_luck_users',
  {
    steamId: text('steam_id').primaryKey().notNull(),
...
export const casesRelatedUsers = sqliteTable(
  'cases_related_users',
  {
...
export const discordCache = sqliteTable(
  'discord_cache',
  {
